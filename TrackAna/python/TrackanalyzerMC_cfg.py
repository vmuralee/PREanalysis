...
process.source = cms.Source("PoolSource",
            fileNames = cms.untracked.vstring(
                '/store/relval/CMSSW_14_1_0_pre5/RelValNuGun/GEN-SIM-RECO/140X_mcRun3_2024_realistic_v11_STD_2024_noPU-v1/2580000/87fb6efc-0437-4aac-947e-f792671a686a.root'
    ...
    secondaryFileNames = cms.untracked.vstring(
        '/store/relval/CMSSW_14_1_0_pre5/RelValNuGun/GEN-SIM-DIGI-RAW/140X_mcRun3_2024_realistic_v11_STD_2024_noPU-v1/2580000/243af760-9eef-4b55-9e61-021af8060242.root',
        '/store/relval/CMSSW_14_1_0_pre5/RelValNuGun/GEN-SIM-DIGI-RAW/140X_mcRun3_2024_realistic_v11_STD_2024_noPU-v1/2580000/8f127347-f6e6-44a1-97c3-2a4370a8f6a2.root'
...
process.GlobalTag = GlobalTag(process.GlobalTag,'140X_mcRun3_2024_realistic_v4' , '')#'140X_dataRun3_Prompt_v3'
...
process.trackAnalyzer = cms.EDAnalyzer('TrackAnalyzer',
                                       ...
                                       g4SimHitsLowTofTagTOB = cms.InputTag("g4SimHits","TrackerHitsTOBLowTof","SIM"),
                                       g4SimHitsHighTofTagTOB = cms.InputTag("g4SimHits","TrackerHitsTOBHighTof","SIM"),

                                       g4SimHitsLowTofTagTIB = cms.InputTag("g4SimHits","TrackerHitsTIBLowTof","SIM"),
                                       g4SimHitsHighTofTagTIB = cms.InputTag("g4SimHits","TrackerHitsTIBHighTof","SIM"),

                                       g4SimHitsLowTofTagTEC = cms.InputTag("g4SimHits","TrackerHitsTECLowTof","SIM"),
                                       g4SimHitsHighTofTagTEC = cms.InputTag("g4SimHits","TrackerHitsTECHighTof","SIM"),

                                       g4SimHitsLowTofTagTID = cms.InputTag("g4SimHits","TrackerHitsTIDLowTof","SIM"),
                                       g4SimHitsHighTofTagTID= cms.InputTag("g4SimHits","TrackerHitsTIDHighTof","SIM"),
...
process.TFileService = cms.Service("TFileService", fileName=cms.string('/scratchssd/muraleed/PREanalysis/flat_ntuples/Flat_RawRelValNuGunTrack.root'))#/scratchssd/muraleed/PREanalysis/flat_ntuples/Flat_RawRelValMuonTrackOT.root

...
process.dump_rawprime = cms.EDAnalyzer("RawPrimeAnalyzer",
...
process.dead_dump_rawprime = cms.EDAnalyzer("DeadStripAnalyzer",)
# Path and EndPath definitions
process.analyzer_step = cms.Path(process.dump_rawprime)
process.deadstrip_step = cms.EndPath(process.dead_dump_rawprime)

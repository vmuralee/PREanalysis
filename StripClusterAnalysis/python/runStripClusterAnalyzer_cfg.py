...
process.clusterTIB = cms.EDAnalyzer('StripClusterAnalysis',
                                         subdet = cms.untracked.string("TIB"),
                                         g4SimHitsCollection = cms.InputTag("g4SimHits","TrackerHitsTIBLowTof","SIM"),
...
process.TFileService = cms.Service("TFileService", fileName=cms.string('test.root'))#'Flat_RawPrimeMCMinBiasNoPUTrackOT.root'))

process.p = cms.Path(process.clusterTIB)

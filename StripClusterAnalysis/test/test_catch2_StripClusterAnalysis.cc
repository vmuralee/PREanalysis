...
static constexpr auto s_tag = "[StripClusterAnalysis]";

TEST_CASE("Standard checks of StripClusterAnalysis", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("StripClusterAnalysis"
